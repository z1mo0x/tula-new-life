window.addEventListener("DOMContentLoaded", () => {
    ...
    function aboutSlider() {
        const heroSlider = new Swiper('.about__slider', {
            navigation: {
    ...
    function sameSlider() {
        const sameSlider = new Swiper('.same-products__slider', {
            navigation: {
                nextEl: '.same-products__slider-next',
                prevEl: '.same-products__slider-prev',
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
            ...
            pagination: {
                el: '.same-products__slider-pagination',
            },
        });
    }
